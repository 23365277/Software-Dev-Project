...
CREATE TABLE `contact_admin` (
  ...
  KEY `admin_id` (`admin_id`),
  CONSTRAINT `contact_admin_ibfk_1` FOREIGN KEY (`contacter_id`) REFERENCES `users` (`id`),
  CONSTRAINT `contact_admin_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `messages` VALUES (1,84,83,'Hello','2026-02-28 18:55:02',NULL,0,0,0,0);
...
CREATE TABLE `preferences` (
  ...
  `gender` enum('male','female','other','no preference') NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `preferences_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `profiles` VALUES (83,'Elizabeth','Martin','1973-12-20','OTHER','Enjoys reading, hiking, and good music.',162,'San Jose','Netherlands','RELATIONSHIP','https://i.pravatar.cc/150?img=24','2025-10-06 15:16:22',NULL),(84,'Jennifer','Martin','1972-09-04','FEMALE','Always curious and learning new things.',173,'Dallas','Spain','RELATIONSHIP','https://i.pravatar.cc/150?img=14','2025-08-08 15:16:22',NULL),(85,'Michael','Anderson','1999-07-13','MALE','Love adventures and meeting new people.',171,'Los Angeles','Sweden','CASUAL','https://i.pravatar.cc/150?img=32','2026-02-13 15:16:23',NULL),(86,'Thomas','White','1996-03-01','MALE','Love adventures and meeting new people.',198,'Los Angeles','Spain','RELATIONSHIP','https://i.pravatar.cc/150?img=19','2025-11-04 15:16:23',NULL),(87,'Richard','Thomas','2007-12-25','MALE','Looking for meaningful connections.',154,'Dallas','UK','RELATIONSHIP','https://i.pravatar.cc/150?img=32','2026-01-31 15:16:23',NULL),(88,'James','White','1991-04-21','MALE','Tech enthusiast and coffee lover.',192,'Dallas','France','RELATIONSHIP','https://i.pravatar.cc/150?img=43','2025-08-19 15:16:23',NULL),(89,'Charles','Harris','1996-04-26','OTHER','Love adventures and meeting new people.',172,'San Antonio','Italy','CASUAL','https://i.pravatar.cc/150?img=23','2026-01-24 15:16:23',NULL),(90,'Barbara','Thomas','1990-04-08','OTHER','Enjoys reading, hiking, and good music.',189,'Phoenix','Italy','RELATIONSHIP','https://i.pravatar.cc/150?img=23','2025-03-29 15:16:23',NULL),(91,'Sarah','Harris','1970-05-26','OTHER','Always curious and learning new things.',187,'Phoenix','Germany','FRIENDSHIP','https://i.pravatar.cc/150?img=5','2025-08-08 15:16:23',NULL),(92,'Elizabeth','Jackson','2008-06-16','OTHER','Looking for meaningful connections.',175,'Dallas','Germany','CASUAL','https://i.pravatar.cc/150?img=6','2025-03-29 15:16:23',NULL),(93,'Robert','Harris','1968-08-02','MALE','Love adventures and meeting new people.',156,'San Diego','Italy','FRIENDSHIP','https://i.pravatar.cc/150?img=70','2025-03-17 15:16:23',NULL),(94,'David','Anderson','1985-10-04','OTHER','Always curious and learning new things.',157,'Houston','Australia','CASUAL','https://i.pravatar.cc/150?img=50','2026-02-03 15:16:23',NULL),(95,'Karen','White','2003-10-13','OTHER','Always curious and learning new things.',188,'Philadelphia','Germany','CASUAL','https://i.pravatar.cc/150?img=31','2025-07-23 15:16:23',NULL),(96,'Joseph','Martin','1969-01-09','MALE','Enjoys reading, hiking, and good music.',176,'Philadelphia','Spain','RELATIONSHIP','https://i.pravatar.cc/150?img=32','2025-07-26 15:16:23',NULL),(97,'Mary','Johnson','1994-10-05','OTHER','Enjoys reading, hiking, and good music.',151,'Philadelphia','USA','CASUAL','https://i.pravatar.cc/150?img=65','2025-03-14 15:16:23',NULL),(98,'Thomas','Jackson','1991-07-09','MALE','Love adventures and meeting new people.',194,'Houston','Australia','CASUAL','https://i.pravatar.cc/150?img=17','2025-12-15 15:16:23',NULL),(99,'Richard','Thomas','1976-07-21','MALE','Enjoys reading, hiking, and good music.',155,'San Jose','Canada','RELATIONSHIP','https://i.pravatar.cc/150?img=7','2025-10-18 15:16:23',NULL),(100,'James','Johnson','1993-04-14','MALE','Enjoys reading, hiking, and good music.',194,'New York','Canada','FRIENDSHIP','https://i.pravatar.cc/150?img=39','2025-04-05 15:16:23',NULL),(101,'Jessica','Johnson','1973-03-23','FEMALE','Love adventures and meeting new people.',188,'Los Angeles','USA','CASUAL','https://i.pravatar.cc/150?img=11','2025-11-01 15:16:23',NULL),(102,'James','Anderson','1984-01-19','MALE','Fun, outgoing, and spontaneous.',190,'Los Angeles','UK','CASUAL','https://i.pravatar.cc/150?img=5','2025-09-15 15:16:23',NULL),(103,'Patricia','Thomas','1968-09-13','OTHER','Enjoys reading, hiking, and good music.',170,'San Jose','Sweden','FRIENDSHIP','https://i.pravatar.cc/150?img=9','2025-07-30 15:16:23',NULL),(104,'Sarah','Taylor','1983-03-17','OTHER','Enjoys reading, hiking, and good music.',176,'Dallas','France','FRIENDSHIP','https://i.pravatar.cc/150?img=32','2025-04-07 15:16:23',NULL),(105,'Susan','Harris','1972-06-15','OTHER','Fun, outgoing, and spontaneous.',174,'Los Angeles','Italy','RELATIONSHIP','https://i.pravatar.cc/150?img=68','2025-05-10 15:16:24',NULL),(106,'Mary','Anderson','1982-04-18','FEMALE','Enjoys reading, hiking, and good music.',183,'Philadelphia','UK','RELATIONSHIP','https://i.pravatar.cc/150?img=44','2025-04-02 15:16:24',NULL),(107,'Elizabeth','Martin','1981-09-01','OTHER','Love adventures and meeting new people.',187,'Los Angeles','UK','FRIENDSHIP','https://i.pravatar.cc/150?img=22','2026-02-08 15:16:24',NULL),(108,'Thomas','White','2005-02-24','OTHER','Always curious and learning new things.',200,'Chicago','Australia','CASUAL','https://i.pravatar.cc/150?img=43','2025-12-13 15:16:24',NULL),(109,'Elizabeth','Smith','1987-11-24','FEMALE','Fun, outgoing, and spontaneous.',151,'Chicago','Netherlands','FRIENDSHIP','https://i.pravatar.cc/150?img=11','2025-02-25 15:16:24',NULL),(110,'John','Johnson','1976-11-07','OTHER','Looking for meaningful connections.',186,'Phoenix','Germany','FRIENDSHIP','https://i.pravatar.cc/150?img=55','2025-08-11 15:16:24',NULL),(111,'James','Johnson','1998-03-14','OTHER','Love adventures and meeting new people.',174,'San Antonio','Netherlands','RELATIONSHIP','https://i.pravatar.cc/150?img=11','2025-03-24 15:16:24',NULL),(112,'Sarah','Harris','1968-01-04','FEMALE','Fun, outgoing, and spontaneous.',198,'San Jose','Sweden','CASUAL','https://i.pravatar.cc/150?img=26','2025-06-26 15:16:24',NULL),(113,'Barbara','Johnson','1982-08-04','FEMALE','Love adventures and meeting new people.',188,'Los Angeles','Netherlands','FRIENDSHIP','https://i.pravatar.cc/150?img=65','2025-04-27 15:16:24',NULL),(114,'David','Thomas','2001-11-06','MALE','Enjoys reading, hiking, and good music.',150,'Houston','Canada','CASUAL','https://i.pravatar.cc/150?img=57','2025-12-25 15:16:24',NULL),(115,'Jessica','Thomas','1978-04-25','FEMALE','Looking for meaningful connections.',165,'San Jose','Italy','RELATIONSHIP','https://i.pravatar.cc/150?img=35','2025-10-22 15:16:24',NULL),(116,'Jennifer','Brown','1996-05-15','FEMALE','Fun, outgoing, and spontaneous.',174,'San Jose','Sweden','CASUAL','https://i.pravatar.cc/150?img=69','2025-06-26 15:16:24',NULL),(117,'David','Martin','2000-07-25','MALE','Tech enthusiast and coffee lover.',173,'San Jose','Sweden','CASUAL','https://i.pravatar.cc/150?img=66','2025-06-08 15:16:24',NULL),(118,'Sarah','Taylor','1998-11-14','OTHER','Looking for meaningful connections.',161,'Houston','Spain','CASUAL','https://i.pravatar.cc/150?img=46','2025-12-08 15:16:24',NULL),(119,'Jessica','White','1999-12-14','OTHER','Fun, outgoing, and spontaneous.',186,'Chicago','Australia','RELATIONSHIP','https://i.pravatar.cc/150?img=4','2025-12-09 15:16:24',NULL),(120,'Linda','Taylor','2007-06-05','FEMALE','Always curious and learning new things.',175,'Los Angeles','Sweden','FRIENDSHIP','https://i.pravatar.cc/150?img=1','2025-10-02 15:16:24',NULL),(121,'Charles','Anderson','1980-07-01','OTHER','Enjoys reading, hiking, and good music.',162,'Philadelphia','Italy','FRIENDSHIP','https://i.pravatar.cc/150?img=39','2025-07-04 15:16:24',NULL),(122,'David','Thomas','1983-10-01','OTHER','Fun, outgoing, and spontaneous.',187,'Houston','UK','CASUAL','https://i.pravatar.cc/150?img=17','2025-10-07 15:16:24',NULL),(123,'John','Johnson','1977-08-18','OTHER','Love adventures and meeting new people.',158,'Los Angeles','Canada','RELATIONSHIP','https://i.pravatar.cc/150?img=5','2025-07-23 15:16:24',NULL),(124,'Elizabeth','Brown','1993-04-23','FEMALE','Enjoys reading, hiking, and good music.',174,'Los Angeles','Italy','CASUAL','https://i.pravatar.cc/150?img=20','2025-06-29 15:16:24',NULL),(125,'Jennifer','Johnson','1986-04-18','OTHER','Looking for meaningful connections.',188,'Dallas','Italy','FRIENDSHIP','https://i.pravatar.cc/150?img=70','2026-01-21 15:16:24',NULL),(126,'David','White','2003-08-24','OTHER','Looking for meaningful connections.',157,'Los Angeles','France','FRIENDSHIP','https://i.pravatar.cc/150?img=32','2025-10-04 15:16:25',NULL),(127,'Karen','Taylor','1976-07-09','OTHER','Love adventures and meeting new people.',165,'Los Angeles','UK','FRIENDSHIP','https://i.pravatar.cc/150?img=61','2025-10-08 15:16:25',NULL),(128,'Jessica','Brown','1998-11-08','FEMALE','Love adventures and meeting new people.',196,'Philadelphia','Italy','RELATIONSHIP','https://i.pravatar.cc/150?img=44','2025-06-28 15:16:25',NULL),(129,'William','Jackson','1983-05-25','MALE','Tech enthusiast and coffee lover.',171,'Houston','Spain','FRIENDSHIP','https://i.pravatar.cc/150?img=63','2025-10-15 15:16:25',NULL),(130,'Jennifer','Smith','1992-09-07','OTHER','Tech enthusiast and coffee lover.',195,'San Antonio','Canada','FRIENDSHIP','https://i.pravatar.cc/150?img=58','2025-09-02 15:16:25',NULL),(131,'Michael','Jackson','1973-12-14','MALE','Always curious and learning new things.',181,'San Antonio','France','CASUAL','https://i.pravatar.cc/150?img=31','2025-12-13 15:16:25',NULL),(132,'James','Thomas','1989-03-05','MALE','Love adventures and meeting new people.',156,'San Diego','Spain','FRIENDSHIP','https://i.pravatar.cc/150?img=52','2026-01-10 15:16:25',NULL),(133,'dv','vd','2026-03-14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 17:38:35',NULL),(134,'d','d','2026-03-14',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 17:42:34',NULL),(138,'p','p','2026-03-08',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 17:45:56',NULL),(140,'k','k','2026-03-20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 17:51:15',NULL),(141,'g','g','2026-03-19',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 17:52:40',NULL),(142,'o','o','2026-03-13',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 17:56:04',NULL),(143,'w','w','2026-03-12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-03-03 18:26:54',NULL),(150,'attack','helicopter','2002-03-06','MALE',NULL,NULL,NULL,NULL,'RELATIONSHIP',NULL,'2026-03-07 13:33:55',30);
...
-- Dump completed on 2026-03-07 13:36:59
